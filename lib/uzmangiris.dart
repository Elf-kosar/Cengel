...
import 'package:cengel_deneme3/uzmananasayfa.dart';
import 'package:cengel_deneme3/sifremiunuttum.dart';
import 'package:cloud_firestore/cloud_firestore.dart';


class UzmanGirisScreen  extends StatefulWidget {
  @override
  _LogintwoScreenState createState() => _LogintwoScreenState();
}

class _LogintwoScreenState extends State<UzmanGirisScreen > {
    ...
    try {
      ...
      if (user != null) {
        DocumentSnapshot userDoc = await FirebaseFirestore.instance
            .collection('expert') // koleksiyon adın buysa
            .doc(user.uid)
            .get();
        ...
        if (userDoc.exists) {
          ...
          if (role == 'expert') {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => UzmanAnaScreen()),
            );
          } else {
            setState(() {
              errorMessage = "Bu giriş sadece uzmanlar içindir.";
            });
